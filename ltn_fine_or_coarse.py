...
def compute_sat_normally(base_model,
    ...
    Args:
        ...
        coarse_label_dict, fine_label_dict,
        coarse_to_fine
        fine_grain_only: if true, train fine code, else coarse mode. The sat is changed accordingly
...
def save_confusion_matrices(num_coarse_label: int, num_all_labels: int,
    ...
    if not fine_grain_only:
        ...
        # Save an array of prediction and groundtruth

        with open(f'{save_path}/prediction_coarse_{description}.pkl', 'wb') as pickle_file:
            pickle.dump(coarse_label_prediction, pickle_file)

        with open(f'{save_path}/ground_truth_coarse_{description}.pkl', 'wb') as pickle_file:
            pickle.dump(coarse_label_ground_truth, pickle_file)

        print('save prediction result successfully!')
        ...
        with open(f'{save_path}/prediction_fine_{description}.pkl', 'wb') as pickle_file:
            pickle.dump(fine_label_prediction, pickle_file)

        with open(f'{save_path}/ground_truth_fine_{description}.pkl', 'wb') as pickle_file:
            pickle.dump(fine_label_ground_truth, pickle_file)
